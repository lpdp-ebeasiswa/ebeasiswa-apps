...
class LetterOfSPDetail extends StatefulWidget {
  const LetterOfSPDetail({super.key, required this.data, required this.title});
  final SP data;
  final String title;
  @override
  State<LetterOfSPDetail> createState() => _LetterOfSPDetailState();
}

class _LetterOfSPDetailState extends State<LetterOfSPDetail> {
  String? uri;
